...
//------------------------------------------------------------------------------------------------------------
   ...
   void FivePointRelativePose(const cv::Mat& intrinsics, std::vector<std::pair<cv::Point3d, cv::Point3d>>&  pts,
   ...
   //------------------------------------------------------------------------------------------------------
   {
      ...
      FivePointRelativePose(intrinsics, train_img_pts, query_img_pts, Qs, Ts);
   }
